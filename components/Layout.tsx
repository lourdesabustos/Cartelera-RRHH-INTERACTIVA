...
export const Layout: React.FC<LayoutProps> = ({ children, branding }) => {
  ...
  return (
    <div className="h-full w-full relative bg-gradient-to-br from-slate-900 via-slate-950 to-blue-950 overflow-hidden">
      ...
      <div className="relative z-10 h-full w-full flex flex-col p-4 lg:p-6">
        {/* Encabezado Simplificado: Solo el Reloj a la derecha */}
        <div className="flex justify-end items-center mb-4 px-4">
          <div className="text-right bg-black/40 backdrop-blur-xl px-7 py-3 rounded-3xl border border-white/10 shadow-2xl">
            ...
            <div className="text-xs text-blue-400 font-bold uppercase tracking-[0.3em] mt-2">
        ...
        <div className="flex-1 bg-white/5 backdrop-blur-md rounded-[3.5rem] border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.3)] overflow-hidden relative">
          {children}
        </div>
      </div>
    </div>
